...
from models.CHAR_CNN_1 import CHAR_CNN_1
from models.CHAR_CNN_2 import CHARCNN_1
from models.CHAR_TCH import CHAR_TCH

tf.flags.DEFINE_string("model", "CHAR_CNN_1", "Specifies which model to use: CHAR_CNN_1 or CHAR_CNN_2")
...
if __name__ == "__main__":
    ...
    if FLAGS.model == "2":
        model = CHAR_CNN_2(input_size=config["data"]["input_size"],
        ...
        model = CHAR_CNN_1(input_size=config["data"]["input_size"],
                             alphabet_size=config["data"]["alphabet_size"],
