...
Original file is located at
    https://colab.research.google.com/drive/1m_sUSg9r4m97SXcX3kZRJC2bv1w72npr
"""
...
def evaluate(
    model, validation_generator, criterion, epoch, log_file, print_every=25
):
    model.eval()
    losses = AverageMeter()
    accuracies = AverageMeter()
...
args = parser.parse_args(['--data_path', '/content/drive/MyDrive/data/en.tsv', '--sep', '\t', '--label_column', 'rating', '--text_column', 'text', '--max_length', '1014'])
run(args)
